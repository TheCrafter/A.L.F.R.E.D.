...
| `desktop-ui/` | TypeScript (Tauri/React) | Phase 4 — dashboard MVP built (event stream, command, status, kill switch, wire inspector, memory review panel); voice deferred |
